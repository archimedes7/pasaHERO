        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>
                Turn off location services (though this may limit some features)
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>
                Post content that is offensive, abusive, or violates the rights
                of others
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside ml-4">
              <li>
                Riders agree to pay the fare shown in the app for each completed
                ride.
              </li>
              <li>
                Drivers agree to provide the transportation service as described
                in the app.
              </li>
              <li>
