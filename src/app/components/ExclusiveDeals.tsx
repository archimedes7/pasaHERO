...
const ExclusiveDeals = () => (
  <section className="exclusive-deals py-10 bg-gray-200">
    <div className="container mx-auto flex items-center justify-between p-6 rounded-lg shadow-lg bg-white">
      <div className="flex items-center">
        <svg className="w-12 h-12 mr-4" viewBox="0 0 640 512" fill="red">
